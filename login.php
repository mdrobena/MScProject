...
<div class="container">
    <form class="form-signin" action="login.php" method="post">
        ...
        <a href="#" id="help" tabindex="0" role="button" data-trigger="focus" data-toggle="popover" title="Contact support" data-content="Email: support@well.org \nPhone: 004465975487">Forgot user id or password?</a>
        <br><br>
